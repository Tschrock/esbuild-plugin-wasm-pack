 ...
 * @param filter The directory filter. Return `true` to include the entry, `false` to ignore it.
 * @param filter The file filter. Return `true` to include the entry, `false` to ignore it.
 */
